...
export const DEFAULT_JOBS: JobPosting[] = [
  {
    id: "job-1",
    title: "ফিল্ড অফিসার (ফিল্ড অপারেশন ও সঞ্চয় আদায়)",
    department: "মাঠ পর্যায় অপারেশন",
    location: "কালিগঞ্জ কার্যালয়, সাতক্ষীরা",
    jobType: "ফুল-টাইম",
    salary: "৳১৫,০০০ - ৳১৮,০০০ + যাতায়াত ভাতা",
    deadline: "২০২৬-০৮-১৫",
    description: "Success সমবায় সমিতির মাঠ পর্যায়ের সঞ্চয় কার্যক্রম পরিচালনা, নতুন সদস্য অন্তর্ভুক্তি এবং সমিতির ক্ষুদ্র ঋণ কার্যক্রম তদারক করার জন্য উদ্যমী ফিল্ড অফিসার আবশ্যক।",
    requirements: [
      "ন্যূনতম এইচএসসি (HSC) অথবা স্নাতক ডিগ্রি অর্জনকারী।",
      "মোটরসাইকেল বা বাইসাইকেল চালনায় পারদর্শী হতে হবে।",
      "উত্তম যোগাযোগ দক্ষতা ও সামাজিক সম্পর্ক স্থাপনে পারদর্শী।",
      "কালিগঞ্জ উপজেলার স্থানীয় স্থায়ী বাসিন্দাদের অগ্রাধিকার দেওয়া হবে।"
    ],
    benefits: [
      "বার্ষিক ২টি উৎসব বোনাস",
      "মাসিক যাতায়াত ভাতা ও মোবাইল বিল",
      "উৎকৃষ্ট পারফরম্যান্সের জন্য বিশেষ ইনসেন্টিভ"
    ],
    isPublished: true,
    order: 1,
    createdAt: "২০২৬-০৭-১০"
  },
  {
    id: "job-2",
    title: "হিসাবরক্ষণ কর্মকর্তা (Accounts Executive)",
    department: "অর্থ ও হিসাব বিভাগ",
    location: "প্রধান কার্যালয়, কালিগঞ্জ",
    jobType: "ফুল-টাইম",
    salary: "৳২০,০০০ - ৳২৫,০০০",
    deadline: "২০২৬-০৮-২০",
    description: "সমিতির দৈনন্দিন লেনদেন হিসাবভূক্তকরণ, সঞ্চয় ও ঋণ সফটওয়্যার ডাটা এন্ট্রি পরিচালনা এবং বার্ষিক অডিট ট্রেইল প্রস্তুত করার জন্য অভিজ্ঞ হিসাবরক্ষণ কর্মকর্তা আবশ্যক।",
    requirements: [
      "বিবিএ / বি.কম (হিসাববিজ্ঞান) অথবা সমমানের ডিগ্রি।",
      "কম্পিউটার ও হিসাবরক্ষণ সফটওয়্যার (Excel, Tally) ব্যবহারে ২ বছরের অভিজ্ঞতা।",
      "ব্যাংকিং বা সমবায় সমিতির হিসাব পরিচালনায় পূর্ব অভিজ্ঞদের অগ্রাধিকার।"
    ],
    benefits: [
    ...
    isPublished: true,
    order: 2,
    createdAt: "২০২৬-০৭-১২"
  },
  {
    id: "job-3",
    title: "সামাজিক উদ্যোগ ও পরিবেশ স্বেচ্ছাসেবক",
    department: "সমাজসেবা ও পরিবেশ",
    location: "কালিগঞ্জ ও পার্শ্ববর্তী ইউনিয়ন",
    jobType: "স্বেচ্ছাসেবক",
    salary: "মাসিক যাতায়াত সম্মানী ভাতা (৳৫,০০০)",
    deadline: "২০২৬-০৮-৩০",
    description: "কালিগঞ্জ অঞ্চলে বিশুদ্ধ পানি সরবরাহ ও বৃক্ষরোপণ সামাজিক উদ্যোগে স্থানীয় তরুণদের অংশগ্রহণে সামাজিক সচেতনতামূলক ক্যাম্পেইন পরিচালনা করার সুযোগ।",
    requirements: [
      "বিশ্ববিদ্যালয়/কলেজ শিক্ষার্থী বা স্থানীয় যুব সমাজ।",
      "সমাজসেবায় আগ্রহী ও মানবিক দৃষ্টিভঙ্গি সম্পন্ন।",
      "দলীয় কাজে নেতৃত্ব প্রদানের মানসিকতা।"
    ],
    benefits: [
      "অফিসিয়াল সেচ্ছাসেবক কাজের অভিজ্ঞতার সার্টিফিকেট",
      "প্রশিক্ষণ ও দক্ষতা উন্নয়ন কর্মশালা",
      "যাতায়াত ও টিফিন ভাতা"
    ],
    isPublished: true,
    order: 3,
    createdAt: "২০২৬-০৭-১৫"
  }
];
